	...
	?>
		...
		<div class="staticText" id="contactText">
			...
			<div style="width: 100%;float: left;vertical-align: middle;margin-bottom: 20px;">
				<div style="width: 80px;float: left;padding: 0px 20px;width: 10%;max-width: 80px;">
					<img alt="Phone" src="http://partyheadphones.com/v2/wp-content/themes/wp_techgostore-theme-package/images/contact_phone.png" style="width:100%;">
				</div>
				<div style="font-size: 18px;margin-top: 3%;">
					<span>607.216.1082</span>
				</div>
			</div>
			<div style="width: 100%;float: left;vertical-align: middle;margin-bottom: 20px;">
				<div style="width: 80px;float: left;padding: 0px 20px;width: 10%;max-width: 80px;"><img alt="email" src="http://partyheadphones.com/v2/wp-content/themes/wp_techgostore-theme-package/images/contact_email.png" style="width:100%;">
				</div>
