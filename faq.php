			...
			<div class="tabbable tabs-default" id="multitabs_1642117843">
				...
				<div class="tab-content" id="multitabs_1642117843_insideContent">
					...
					<div class="tab-pane fade active in" id="multitabs_1642117843_inside1">
						<h4 class="question">How does the Unisono Silent Disco RF Headphone offer a better silent disco experience?</h4>
						...
						<h4 class="question">How does the Party Headphones System work? What can I plug into?</h4>
						...
						<h4 class="question">How many audio channels do you have?</h4>
						<p>The Unisono Silent Disco RF Headphone system offers two channels of flawless audio.</p>
						<h4 class="question">What is the wireless range of the Unisono Silent Disco RF Transmitter?</h4>
						<p>Our system can broadcast your playlist at a radius of up to 300 feet.</p>
						<h4 class="question">How long does the Unisono Silent Disco RF Headphone batteries last?</h4>
						<p>Batteries last from 5-8 hours on a single charge.</p>
						<h4 class="question">How are the headphones charged?</h4>
						<p>Our custom mini-USB charging hubs allow you to charge up to 24 headphones at once.</p>
						<h4 class="question">How long does it take to fully charge the headphones?</h4>
						...
						<h4 class="question">What kind of batteries do the headphones use?</h4>
